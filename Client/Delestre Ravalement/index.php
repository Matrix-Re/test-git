...
<?php
    ...
    $read_database = $db->query("SELECT notice, phone_number, mail_addresse FROM presentation");
...
?>
	...
	<h2 class="intro" style="margin-left: 100px; margin-right: 100px;"><?php echo $notice ?></h2>
	...
	<form method="POST">
		...
		<h2>tel: <?php echo $phone_number ?></h2>
		<h2>mail: <?php echo $mail_addresse ?></h2>
		<br>
...
try {
	...
	$mail->SMTPAuth   = true;
    $mail->Username   = 'arneaweb@gmail.com';
    $mail->Password   = 'sxkrlweczqexbcfo';
    $mail->SMTPSecure = 'tls';                               
    $mail->Port       = 587;

    $mail->setFrom('arneaweb@gmail.com');
    $mail->addAddress($mail_addresse);
...
#_AFFICHAGE DES AVIS CLIENT_#
    ...
    $c = $db->query("SELECT nom, note, commentaire FROM notice ORDER BY id DESC");
...
<h6><a href="portail_administration.php">portail_administration</a></h6>
