...
<?php
    ...
    $infogen = $_SESSION['infogen'];

    if(is_null($infogen)){header('Location:index.php');}

$prix = $https + $google + $lien + $page + $infogen;
?>

    <form action="payement3.php" class="stripe" id="payement_form" method="POST">
