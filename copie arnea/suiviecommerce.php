...
<body>
	...
	<h2><img src="picture\suivi e-commerce.png" width="100">Prix sur de devis</h2>


	<div>Vous possède un site e-commerce, et vous voulez apporter<br>
	...
	de design, alors commandez dès maintenant notre suivi e-commerce.<br>
	Nos développeur vous accompagne dans l'amélioration de votre<br>
	site internet et votre entreprise</div>


        <div class="br">Nous aurons besoin des éléments suivants pour réaliser votre site e-commerce:<br>
...
<?php
            ...
            $c = $db->prepare("SELECT id FROM suiviecom WHERE id = 5 or id > 5");
            if("id = 5" or "id > 5"){
            ...
            $req = $db->prepare("INSERT INTO suiviecom(nom, email, commentaire) VALUES(?, ?, ?)");
